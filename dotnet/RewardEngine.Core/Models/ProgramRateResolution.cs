...
public record ProgramRateResolution
{
    ...
    public RewardBridgeRule? MatchedBridgeRule { get; init; }   // 相容舊版 Bridge 規則
    ...
    public bool BreakTriggered => Program.RewardCalBreak || (MatchedBridgeRule?.RewardCalBreak ?? false);
}