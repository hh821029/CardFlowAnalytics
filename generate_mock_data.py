...
def generate_mock_data():
    ...
    cathay_data = [
        ...
        ["2025/10/25", "2025/10/27", "STEAM", "US/USD", "30", "960", "0000", "2025/10/27"],
    ...
    # ==========================================
    # 2. Esun (U Bear & Unicard) Mock - UTF-8-sig
    # ==========================================
    ...
    esun_data = [
        ...
        ["卡號：5413（U bear卡正卡）", "", "", "", "", "", "", "", "", ""],
        ["114/06/05", "114/06/07", "GOOGLE*Pokemon GO\tUSA\t06/07", "交易", "TWD", "200", "TWD", "200", "", "5413"],
    ...
    with open(esun_filename, "w", encoding="utf-8-sig") as f:
    ...
    ctbc_data = [
        ...
        ["115/06/01", "115/06/03", "LinePay－統一超商", "TWD", "150", "150", "4321", "", "TW"],
        ["115/06/02", "115/06/04", "統一超商－實體門市", "TWD", "15", "15", "4321", "", "TW"],
        ["115/06/05", "115/06/07", "一般商品買賣", "TWD", "1200", "1200", "4321", "", "TW"]
    ]
