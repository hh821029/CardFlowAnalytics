...
---
## 📄 授權條款 (License)
本專案採用 **MIT License (含非商業限制)** 授權：
* **非商業用途**：開放供個人學習、學術研究與技術交流自由使用。
* **商業用途限制**：未獲得原作者事前書面授權前，嚴禁將本專案原始碼（包含 C# 瀑布式回饋引擎與 ETL 管線）用於任何商業營利或 SaaS 服務。
* 詳細條款請參閱根目錄下的 [LICENSE](LICENSE) 檔案。商業授權洽詢請透過 GitHub 聯繫原作者。
